    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse>> GetUsuarios()
        {
            try
            {
                ...
                var arrayUsuarios = new List<Expression<Func<Usuarios, object>>>()
                {
                    e=>e.Empresa
                };
                IEnumerable<Usuarios> UsuariosList = await _UsuariosRepositorio.ObtenerTodos(null, arrayUsuarios.ToArray());
        ...
        public async Task<ActionResult<ApiResponse>> GetUsuarios(int id)
        {
            try
            {
                ...
                var Usuarios = await _UsuariosRepositorio.Obtener(v => v.id == id, true, arrayUsuarios.ToArray());
