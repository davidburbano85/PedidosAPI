    ...
    public class ProductosCartaController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse>> GetProductosCarta()
        {
            try
            {
                ...
                var arrayProductos= new List<Expression<Func<ProductosCarta, object>>>()
                {
                    e=>e.Empresa,
                    s=>s.Stock
                };
                IEnumerable<ProductosCarta> ProductosCartaList = await _ProductosCartaRepositorio.ObtenerTodos(null, arrayProductos.ToArray());
        ...
        public async Task<ActionResult<ApiResponse>> GetProductosCarta(int id)
        {
            try
            {
                ...
                var pedido = await _ProductosCartaRepositorio.Obtener(v => v.id == id, true, arrayProductos.ToArray());
